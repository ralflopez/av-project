defmodule AvProjectWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AvProjectWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AvProjectWeb.Gettext, "errors", msg, opts)
    end
  end
