defmodule AvProjectWeb.ProductLiveTest do
  use AvProjectWeb.ConnCase

  import Phoenix.LiveViewTest
  import AvProject.ProductsFixtures

  @create_attrs %{brand: "some brand", category: "some category", description: "some description", name: "some name", price: 120.5}
  @update_attrs %{brand: "some updated brand", category: "some updated category", description: "some updated description", name: "some updated name", price: 456.7}
  @invalid_attrs %{brand: nil, category: nil, description: nil, name: nil, price: nil}
